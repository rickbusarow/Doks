...
import com.rickbusarow.docusync.gradle.internal.fileTree
import com.rickbusarow.docusync.internal.stdlib.applyEach
...
abstract class DocusyncSourceSet @Inject constructor(
  ...
  /**
   * Adds a set of document paths to this source set. The given paths are
   * evaluated as per [Project.files][ org.gradle.api.Project.files] .
   *
   ...
   *
   * Addition to [docs] is done via [ConfigurableFileCollection.from]. For other operations such
   * as [setFrom][ ConfigurableFileCollection.setFrom] , access the [docs] property directly.
   *
