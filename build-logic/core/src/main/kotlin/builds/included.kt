...
/**
 * Look at the root project of an included build, find any task with a matching name,
 * and return it or null. This is an alternative to the standard [IncludedBuild.task][
 * org.gradle.api.initialization.IncludedBuild.task] function in that the
