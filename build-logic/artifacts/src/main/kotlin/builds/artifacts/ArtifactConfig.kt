 ...
 * @property group The maven "group", which should always be `com.rickbusarow.docusync`. This is the
 *     `GROUP` property in the Gradle plugin.
 * @property artifactId The maven "module", such as `workflow-core-jvm`. This is the `POM_ARTIFACT_ID`
